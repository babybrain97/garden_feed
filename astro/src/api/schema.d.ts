...
export interface components {
  schemas: {
    PluginUploadFileDocument: {
      ...
      /**
       * @description A datetime field
       * @default 2025-12-17T14:39:48.896Z
       */
      publishedAt: string;
      related: unknown;
    };
  ...
  "post/get/posts": {
    parameters: {
      query?: {
        ...
        sort?:
          | ("Description" | "Date" | "createdAt" | "updatedAt" | "publishedAt")
          | (
              | "Description"
              | "Date"
              | "createdAt"
        ...
        content: {
          "application/json": {
            data: {
              ...
              /**
               * @description A datetime field
               * @default 2025-12-17T14:39:48.894Z
               */
              publishedAt: string;
      ...
      content: {
        "application/json": {
          data: {
            ...
            /**
             * @description A datetime field
             * @default 2025-12-17T14:39:48.899Z
             */
            publishedAt: string;
            /** @description A media field */
            Image?: unknown;
        ...
        content: {
          "application/json": {
            data: {
              ...
              /**
               * @description A datetime field
               * @default 2025-12-17T14:39:48.900Z
               */
              publishedAt: string;
              /** @description A media field */
              Image?: components["schemas"]["PluginUploadFileDocument"];
        ...
        content: {
          "application/json": {
            data: {
              ...
              /**
               * @description A datetime field
               * @default 2025-12-17T14:39:48.898Z
               */
              publishedAt: string;
              /** @description A media field */
              Image?: components["schemas"]["PluginUploadFileDocument"];
      ...
      content: {
        "application/json": {
          data: {
            ...
            /**
             * @description A datetime field
             * @default 2025-12-17T14:39:48.901Z
             */
            publishedAt?: string;
            /** @description A media field */
            Image?: unknown;
        ...
        content: {
          "application/json": {
            data: {
              ...
              /**
               * @description A datetime field
               * @default 2025-12-17T14:39:48.902Z
               */
              publishedAt: string;
              /** @description A media field */
              Image?: components["schemas"]["PluginUploadFileDocument"];
